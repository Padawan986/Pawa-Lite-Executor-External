...
class Executor:
    ...
    def injected(self):
        try:
            ...
            if bridge.is_dm_confirmed(dm.address):
                return True
            return dm.find('CoreGui', '_pawalite') is not None
        except:
            return False
    ...
    def inject(self):
        ...
        try:
            ...
            bytecode = bridge.get_init_bin()
            print(len(bytecode), 'bytes of init bytecode')
    ...
    def execute(self, source: str | bytes):
        ...
        root: sdk.Instance = coregui.find_first_child('_pawalite')
