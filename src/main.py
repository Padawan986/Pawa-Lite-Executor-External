...
appdata = os.environ['APPDATA']+'\\Pawa-Lite-BetaV2'

if __name__ == '__main__':

    legacy = os.environ['APPDATA']+'\\FunnyExecutor'
    if not os.path.exists(appdata) and os.path.exists(legacy):
        try:
            os.rename(legacy, appdata)
        except OSError:
            pass
